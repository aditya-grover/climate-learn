...
class DataModule(LightningDataModule):
    def __init__(
        ...
        self.train_dataset = caller(root_dir, root_highres_dir, in_vars, out_vars, pred_range.hours(), train_years, subsample.hours(), "train", sys_gen=sys_gen)

        val_years = range(val_start_year, test_start_year)
        self.val_dataset = caller(root_dir, root_highres_dir, in_vars, out_vars, pred_range.hours(), val_years, subsample.hours(), "val", sys_gen=sys_gen)
        ...
        self.test_dataset = caller(root_dir, root_highres_dir, in_vars, out_vars, pred_range.hours(), test_years, subsample.hours(), "test", sys_gen=sys_gen)
