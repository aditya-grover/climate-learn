...
def plot_rmse(axs, data, variable, resolution):
    ...
    axs.plot(
        *get_unet_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color="C2",
        label=f"UNet",
    ...
    axs.plot(
        *get_vit_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color="C3",
        label=f"ViT",
    ...
    axs.plot(
        *get_ifs_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color="C4",
        alpha=0.6,
    ...
    axs.plot(
        *get_persistence_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color="C5",
        alpha=0.7,
    ...
    axs.plot(
        *get_climatology_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color="C6",
        alpha=0.7,
