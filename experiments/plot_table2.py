...
def plot_rmse(axs, data, variable, resolution):
    ...
    axs.plot(
        *get_resnet_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color=color,
        label=f"ResNet-direct",
    )
    ...
    axs.plot(
        *get_resnet_cont_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color="C2",
        label=f"ResNet-cont",
    ...
    axs.plot(
        *get_resnet_iter_value(data, variable, resolution),
        marker="o",
        markersize=2.5,
        color="C3",
        label=f"ResNet-iter",
...
def main(var, rmsefile, accfile, metric, resolution, output):
    ...
    plt.rcParams.update(
        figsizes.icml2022_full(nrows=2, ncols=3, height_to_width_ratio=0.9)
    )
