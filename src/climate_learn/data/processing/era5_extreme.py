...
parser.add_argument(
    "source",
    help="The directory where the raw ERA5 data is stored."
)
parser.add_argument(
    "source_npz",
    help="The directory where the processed ERA5 data is stored."
)
parser.add_argument(
    "target",
    help="The directory to save the processed files."
)
