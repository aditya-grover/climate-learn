...
# CMD="scripts/run_cmip6_continuous.py --config scripts/configs/config_cmip6_mask2former_stage2.yaml"
# CMD="scripts/run_cmip6_continuous.py --config scripts/configs/config_cmip6_swinv2_stage2.yaml"
CMD="scripts/run_cmip6_continuous.py --config scripts/configs/config_cmip6_vit_pretrained_stage2.yaml"
